        ...
        <div class="sidebar-wrapper active">
            ...
            <div class="sidebar-menu">
                <ul class="menu">
                    ...
                    <li class="sidebar-item  has-sub">
                        <a href="<%= request.getContextPath() %>/back_end/appraisal_case/select_page.jsp" class='sidebar-link'>
                            <i class="bi bi-stack"></i>
                            <span>估價管理</span>
                        </a>
                        <ul class="submenu ">
                            ...
                            <li class="submenu-item ">
                                <a href="<%=request.getContextPath()%>/back_end/appraisal_case/select_page.jsp">管理估價案件類別</a>
                            </li>
                        </ul>
                    </li>                    
